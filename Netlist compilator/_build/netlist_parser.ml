  ...
  fun _menhir_env _menhir_stack _menhir_s _v ->
    ...
    | MenhirState20 ->
        ...
        | EOF ->
            let _menhir_stack = Obj.magic _menhir_stack in
            let _menhir_stack = Obj.magic _menhir_stack in
            let ((((_menhir_stack, _, (xs0 : (Netlist_ast.ident list))), _, (xs1 : (Netlist_ast.ident list))), _, (xs2 : ((Netlist_ast.Env.key * Netlist_ast.ty) list))), _, (eqs : (Netlist_ast.equation list))) = _menhir_stack in
            let _9 = () in
            let _7 = () in
            let _5 = () in
            let _3 = () in
